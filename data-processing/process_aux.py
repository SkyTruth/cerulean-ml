...
def invert_geom(ds="location_of_the_worlds_petroleum_fields__xtl.json", out="inverted.json"):
...
def process_csv_infra(ds="ml_aux_files_detections_2020_infrastructureOnly_v20210604_buffered_dissolved_centroids.csv", out="infra_locations.json"):
