...
function links_generator() {
    ...
    cog_detection_v1_url=$(exist_object s3://skytruth-cerulean/outputs/rasterized_detection_v1/cog/$sceneIdid.tiff)
    cog_all_infrastructure_url=$(exist_object s3://skytruth-cerulean/outputs/all_infrastructure/cog/$sceneIdid.tiff)
    cog_leaky_infrastructure_url=$(exist_object s3://skytruth-cerulean/outputs/leaky_infrastructure/cog/$sceneIdid.tiff)
